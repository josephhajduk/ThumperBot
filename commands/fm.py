...
class ForwardMessage(BotCommand):
    ...
    def handle_message(self, msg, chat_handler):
        self.bot.sendMessage(self._target_user_user.telegram_id, "Message from:" + chat_handler.user.main_character.name)
        self.bot.forwardMessage(self._target_user_user.telegram_id, self._user.telegram_id, msg["message_id"])
        self.finished()
